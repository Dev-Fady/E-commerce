...
class BannerProductDetailsView extends StatefulWidget {
  const BannerProductDetailsView({
    super.key,
    required this.data,
  });
  final Products data;
  ...
  @override
  _BannerProductDetailsViewState createState() =>
      _BannerProductDetailsViewState();
}

class _BannerProductDetailsViewState extends State<BannerProductDetailsView> {
  int currentIndex = 0;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.data.discount != 0)
                      OldPrice(oldPrice: widget.data.oldPrice.toInt()),
                    const SizedBox(height: 10),
